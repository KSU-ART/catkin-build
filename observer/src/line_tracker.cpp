/*************************************************************
 * this program will detect gridlines and report their position
 * ***********************************************************/
...
public:
  findLines()
    : it_(nh_)
  {
	///line_pub = n.advertise<std_msgs::Float32>("green_plate_angle", 100);
    image_sub_ = it_.subscribe("usb_cam1/image_raw", 1, &findLines::Cb1, this);
    image_sub_2_ = it_.subscribe("usb_cam2/image_raw", 1, &findLines::Cb2, this);
  }
  ...
  void Cb1(const sensor_msgs::ImageConstPtr& msg)
  {
