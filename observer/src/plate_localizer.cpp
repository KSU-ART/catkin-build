...
plate_localizer::plate_localizer()
{
	...
	r_plate_angle = s_.subscribe("/observer/red_plate_angle", 1, &plate_localizer::update_g_angle, this);
	g_plate_angle = s_.subscribe("/observer/green_plate_angle", 1, &plate_localizer::update_r_angle, this);
