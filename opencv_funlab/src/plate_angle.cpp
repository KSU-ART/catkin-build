...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("green_binary", 1, &findAngle::imageCb, this);
  }
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
	...
	//convert to binary image (with edges form shapes):
	//cv::Mat binary_image;
	//cv::Canny(gray, binary_image, 0, 50,5);
	...
	//destination image for outputing results:
