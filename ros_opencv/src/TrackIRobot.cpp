...
public:
 ...
 ColorDetector()
   : it_(nh_)
 {
   result_pub= nh_.advertise<ros_opencv::TrackingPoint>("irobotinfo" , 1);
...
Mat imgRedThresh = GetThresholdedImage(frameSmall, (_InputArray)cvScalar(0,200,50), (_InputArray)cvScalar(5,255,150));
Mat imgRedThresh2 = GetThresholdedImage(frameSmall, (_InputArray)cvScalar(175,200,50), (_InputArray)cvScalar(180,255,150));
